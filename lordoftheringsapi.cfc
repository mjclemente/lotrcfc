...
*/
component displayname="lotrcfc"  {

    variables._lotrcfc_version = '0.0.0'; 

    public any function init(
        string apiKey = '',
        string baseUrl = "https://the-one-api.herokuapp.com/v1",
        ...
        var secrets = {
            'apiKey': 'LORDOFTHERINGSAPI_API_KEY'
        };
    ...
    * @hint List books
    */
    public struct function listBooks() {
      return apiCall( 'GET', '/book' );
    }

    /**
    * @hint List movies
    */
    public struct function listMovies() {
        return apiCall( 'GET', '/movie' );
    }

    /**
    * @hint List quotes
    */
    public struct function listQuotes() {
        return apiCall( 'GET', '/quote' );
    }

    /**
    * @hint List characters
    */
    public struct function listCharacters() {
        return apiCall( 'GET', '/character' );
    }

    /**
    * @hint Retrieve a single book by ID.
    */
    public struct function getBook( required string id ) {
      return apiCall( 'GET', '/book/#id#' );
    }

    /**
    * @hint Retrieve a single movie by ID.
    */
    public struct function getMovie( required string id ) {
        return apiCall( 'GET', '/movie/#id#' );
    }

    /**
    * @hint Retrieve a single quote by ID.
    */
    public struct function getQuote( required string id ) {
        return apiCall( 'GET', '/quote/#id#' );
    }

    /**
    * @hint Retrieve a single character by ID.
    */
    public struct function getCharacter( required string id ) {
        return apiCall( 'GET', '/character/#id#' );
    }
    ...
    */
    public struct function listChaptersByBook( required string id ) {
        return apiCall( 'GET', '/book/#id#/chapter' );
    }

    /**
    * @hint List quotes by movie
    */
    public struct function listQuotesByMovie( required string id ) {
        return apiCall( 'GET', '/movie/#id#/quote' );
    }

    /**
    * @hint List quotes by character
    */
    ...
    private struct function getBaseHttpHeaders() {
        return {
            ...
            'User-Agent' : 'lotrcfc/#variables._lotrcfc_version# (ColdFusion)'
        };
    }
